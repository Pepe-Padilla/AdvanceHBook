                ...
                [change enumerateKeysAndObjectsUsingBlock:^(NSNumber *key, id obj, BOOL *stop) {
                    ...
                    switch (type)
                    {
                        ...
                        case NSFetchedResultsChangeUpdate:
                            ...
                            break;
                        case NSFetchedResultsChangeMove:
                            //[self.collectionView moveSection:[NSIndexSet indexSetWithIndex:[obj[0] unsignedIntegerValue]]
                            //                       toSection:[NSIndexSet indexSetWithIndex:[obj[1] unsignedIntegerValue]]];
                            break;
                    }
                }];
            }
